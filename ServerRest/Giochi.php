...
class Giochi
	...
	function readOf()	{
		$query = "SELECT * FROM " . $this->table_name . " WHERE mail_editore=:mail_editore";
		$stmt = $this->conn->prepare($query);
	...
	function create(){	 
    	$query = "INSERT INTO " . $this->table_name ." SET  nome=:nome, descrizione=:descrizione, prezzo=:prezzo, sconto=:sconto, mail_editore=:mail_editore, main_img=:main_img, valutazione=:valutazione, data_pubblicazione=:data_pubblicazione"; 
    	$stmt = $this->conn->prepare($query);  
